...
import { loginSchema, type LoginInput } from '@emc3/shared';
...
export function LoginPage() {
  ...
  // Check for OAuth error or success message
    ...
    <div className="min-h-screen bg-bg flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-text">Hoş Geldiniz</h2>
          <p className="mt-2 text-muted">Hesabınıza giriş yapın</p>
        </div>

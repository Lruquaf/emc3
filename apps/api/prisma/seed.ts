...
async function main() {
  ...
  // System category
  const catDigerGenel = await createCategoryWithClosure(
    "Diğer/Genel",
    "diger-genel",
    true,
  );
  ...
  // Sub-categories
  const catHadisUsulu = await createCategoryWithClosure(
    "Hadis Usulü",
    "hadis-usulu",
    false,
    catHadis.id,
  );
  const catHadisSerhleri = await createCategoryWithClosure(
    "Hadis Şerhleri",
    "hadis-serhleri",
    false,
    catHadis.id,
  ...
  const catIbadetler = await createCategoryWithClosure(
    "İbadetler",
    "ibadetler",
    false,
    catFikih.id,
  );
  const catMuamelat = await createCategoryWithClosure(
    "Muamelat",
    "muamelat",
    false,
    catFikih.id,
  );
  const catFikihUsulu = await createCategoryWithClosure(
    "Fıkıh Usulü",
    "fikih-usulu",
    false,
    catFikih.id,
  ...
  const catTarikatlar = await createCategoryWithClosure(
    "Tarikatlar",
    "tarikatlar",
    false,
    catTasavvuf.id,
  );
  const catTasavvufKlasikleri = await createCategoryWithClosure(
    "Tasavvuf Klasikleri",
    "tasavvuf-klasikleri",
    false,
    catTasavvuf.id,
  ...
  const catAkaid = await createCategoryWithClosure(
    "Akaid",
    "akaid",
    false,
    catKelam.id,
  );
  const catIslamFelsefesi = await createCategoryWithClosure(
    "İslam Felsefesi",
    "islam-felsefesi",
    false,
    catKelam.id,
  ...
  const catTefsirUsulu = await createCategoryWithClosure(
    "Tefsir Usulü",
    "tefsir-usulu",
    false,
    catTefsir.id,
    ...
    create: {
      ...
      profile: {
        create: {
          ...
          about:
            "e=mc³ platform yöneticisi. İlmî içerik kalitesinden sorumluyum.",
    ...
    create: {
      ...
      profile: {
        create: {
          ...
          about:
            "Hadis ve Fıkıh alanında uzman moderatör. İçerik inceleme sorumlusu.",
    ...
    create: {
      ...
      profile: {
        create: {
          ...
          about:
            "Kelam ve Tefsir alanında uzman moderatör. Akademik içerik denetçisi.",
    ...
    create: {
      ...
      profile: {
        create: {
          ...
          about:
            "Tasavvuf tarihçisi. Klasik dönem sufizmi üzerine araştırmalar.",
    ...
    create: {
      ...
      profile: {
        create: {
          ...
          about:
            "Siyer araştırmacısı. Hz. Peygamber'in hayatı üzerine çalışmalar.",
          socialLinks: {},
        },
      },
    },
  ...
  // Helper to create published article (Article model has no slug; slug removed in migration)
  ...
  await prisma.revision.create({
    data: {
      ...
      categories: {
        create: [
          { categoryId: catTefsir.id },
          { categoryId: catTefsirUsulu.id },
        ],
      },
    },
  });
  ...
  await prisma.revisionReview.create({
    data: {
      ...
      action: "FEEDBACK",
      feedbackText:
        "Makalenin giriş bölümü güçlendirilmeli. Ayrıca modern dönem içtihat tartışmalarına daha fazla örnek eklenebilir.",
    },
  });
  ...
  await prisma.revision.create({
    data: {
      ...
      categories: {
        create: [
          { categoryId: catKelam.id },
          { categoryId: catIslamFelsefesi.id },
        ],
      },
    },
  });
  ...
  const opinion1 = await prisma.opinion.create({
    data: {
      ...
      bodyMarkdown:
        "Hadis ilminin temel kavramlarını çok güzel özetlemişsiniz. Yeni başlayanlar için ideal bir giriş makalesi.",
      likeCount: 8,
    },
  });
  ...
  await prisma.opinion.create({
    data: {
      ...
      authorId: userMehmet.id,
      bodyMarkdown:
        "İsnad sistemi bölümü biraz daha genişletilebilirdi. Yine de genel olarak faydalı bir çalışma.",
      likeCount: 3,
    },
  });
  ...
  await prisma.opinion.create({
    data: {
      ...
      authorId: userZeynep.id,
      bodyMarkdown:
        "Akademik düzeyde sağlam bir makale. Kaynakça da tatmin edici.",
      likeCount: 5,
    },
  });
  ...
  await prisma.opinion.create({
    data: {
      ...
      authorId: userAli.id,
      bodyMarkdown:
        "Tasavvufun temel kavramlarını anlaşılır bir dille aktarmışsınız.",
      likeCount: 15,
    },
  });
  ...
  console.log(
    "  • Articles: 15 (7 published + 1 approved + 2 in_review + 1 changes_req + 4 draft)",
  );
  ...
  console.log(
    "│ admin@emc3.dev             │ admin           │ Admin123!   │ ADMIN        │",
  );
  console.log(
    "│ moderator1@emc3.dev        │ moderator1      │ Mod123!     │ REVIEWER     │",
  );
  console.log(
    "│ moderator2@emc3.dev        │ moderator2      │ Mod123!     │ REVIEWER     │",
  );
  console.log(
    "├────────────────────────────┼─────────────────┼─────────────┼──────────────┤",
  );
  console.log(
    "│ ahmet.yilmaz@emc3.dev      │ ahmetyilmaz     │ User123!    │ USER         │",
  );
  console.log(
    "│ fatma.kaya@emc3.dev        │ fatmakaya       │ User123!    │ USER         │",
  );
  console.log(
    "│ mehmet.demir@emc3.dev      │ mehmetdemir     │ User123!    │ USER         │",
  );
  console.log(
    "│ zeynep.celik@emc3.dev      │ zeynepcelik     │ User123!    │ USER         │",
  );
  console.log(
    "│ ali.ozturk@emc3.dev        │ aliozturk       │ User123!    │ USER         │",
  );
  console.log(
    "│ ayse.sahin@emc3.dev        │ aysesahin       │ User123!    │ USER         │",
  );
  console.log(
    "│ mustafa.arslan@emc3.dev    │ mustafaarslan   │ User123!    │ USER         │",
  );
  console.log(
    "├────────────────────────────┼─────────────────┼─────────────┼──────────────┤",
  );
  console.log(
    "│ elif.yildiz@emc3.dev       │ elifyildiz      │ User123!    │ NOT VERIFIED │",
  );
  console.log(
    "│ banned.user@emc3.dev       │ banneduser      │ User123!    │ BANNED       │",
  );
  console.log(
    "└────────────────────────────┴─────────────────┴─────────────┴──────────────┘",
  );
